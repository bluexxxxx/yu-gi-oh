import{l as a,aG as $,ag as g,c as b,b4 as f,d as l,x as m,r as x,e as v,h as O}from"./index.4d80bd92.js";import{p as u,N as j,g as T}from"./Popover.d0ca713d.js";const{cubicBezierEaseInOut:s,cubicBezierEaseOut:E,cubicBezierEaseIn:C}=$;function _({overflow:n="hidden",duration:e=".3s",originalTransition:t="",leavingDelay:o="0s",foldPadding:i=!1,enterToProps:d=void 0,leaveToProps:h=void 0,reverse:c=!1}={}){const p=c?"leave":"enter",r=c?"enter":"leave";return[a(`&.fade-in-height-expand-transition-${r}-from,
